...
- Keyboard support
- Built-in file picker for browsing and launching ROMs (a26, a78, bin)
- Save, load, and delete state support
- Resume last played rom from file picker
- Multiple video modes (Original Aspect Ratio, 2X and 3X integer scaling (Touchpad only), and Fullscreen)
...
- Update checker allows you to update straight from the app
- Resizable controls
